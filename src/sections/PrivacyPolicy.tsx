...
>>>>>>> 92038dcce275492eec33835472d3ff77df0584b4
      ...
      <p>
        Ambience Creacions ("we" or "us" or "our") respects the privacy of our users. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.
      </p>
      
      <h3 className="text-xl font-semibold mt-4">2. Collection of Your Information</h3>
      <p>
      ...
      <ul className="list-disc pl-6 space-y-2 mt-2">
        <li>
          <strong>Personal Data:</strong> Personally identifiable information, such as your name, email address, telephone number, and home address, that you voluntarily give to us when you register with the Website or when you choose to participate in various activities related to the Website.
        </li>
        <li>
        ...
        <li>
          <strong>Financial Data:</strong> Financial information, such as data related to your payment method, that we may collect when you purchase services from us.
        </li>
      </ul>
      
      <h3 className="text-xl font-semibold mt-4">3. Use of Your Information</h3>
      <p>
        Having accurate information about you permits us to provide you with a smooth, efficient, and customized experience. Specifically, we may use information collected about you via the Website to:
      </p>
      <ul className="list-disc pl-6 space-y-2 mt-2">
        <li>Create and manage your account.</li>
        <li>Email you regarding your account or property inquiries.</li>
        <li>Fulfill and manage property viewings and purchases.</li>
        <li>Send you a newsletter and other relevant communications.</li>
      ...
      <h3 className="text-xl font-semibold mt-4">4. Disclosure of Your Information</h3>
      <p>
      ...
      <p className="mt-2">
        ...
        Email: privacy@ambiencecreacions.com<br />
        Phone: +91-9717003006
      </p>
    </div>
  );
